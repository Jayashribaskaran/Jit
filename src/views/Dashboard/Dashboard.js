      ...
      <div className="animated fadeIn">
        ...
        <Row>
          ...
          <i className="fa fa-facebook"></i>
              ...
              <ul>
                <li>
                <a href="https://www.facebook.com"><strong>89k</strong></a>
                  <span>friends</span>
                </li>
                <li>
                  <strong>459</strong>
          ...
          <Col xs="6" sm="6" lg="3">
            <div className="social-box twitter">
              ...
              <ul>
                <li>
                <a href="https://twitter.com/login?lang=en"><strong>973k</strong></a>
                  <span>followers</span>
                </li>
                <li>
                  <strong>1.792</strong>
                  ...
                  <Col xs="12" md="6" xl="4">
                    ...
                    <ul className="horizontal-bars type-2">
                      ...
                      <li>
                        ...
                        <a href=""><span className="title">Facebook</span></a>
                      ...
                      <li>
                        ...
                        <a href=""><span className="title">Twitter</span></a>
                      ...
                      <li>
                        ...
                        <a href=""><span className="title">LinkedIn</span></a>
